...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        // NOTICE mbTrackInView == false 的点有几种：
        ...
        // c 不在当前相机视野中的点（即未通过 isInFrustum 判断）     //?
        bool mbTrackInView;
        // TrackLocalMap - UpdateLocalPoints 中防止将 MapPoints 重复添加至 mvpLocalMapPoints 的标记
        ...
        // new1
        // todo 由于在加载地图时我们只有 Position 以及当前的 Map，所以需要重新定义一种 MapPoint 类的构造函数以满足要求。
